...
offers: \opeinsert{\alpha} which introduces a new variable of type
...
\\ \constructor
 {ρ : \Env{}(k, l)
}{ρ \envextend{} : \Env{}(\texttt{suc}(k), \texttt{suc}(l))
}
\and \constructor
...
}{\Env{}(Θ₁, ρ ∙ t, Θ₃, Γ ∙ \fresh{σ})
}
\and \constructor
 {\Env{}(Θ₁, ρ, Θ₂, Γ)
}{\Env{}(Θ₁ ∙ \fresh{σ}, ρ \envextend{}, Θ₂ ∙ \stale{σ}, Γ ∙ \fresh{σ})
}
\end{mathpar}
...
\constructor
 {\Env{}(Θ₁, ρ, Θ₂, Γ)
}{\Env{}(Θ₁, ρ ∙ t, Θ₂, Γ ∙ \stale{σ})
}
\and \constructor
 {\Env{}(Θ₁, ρ, Θ₂, Γ)
}{\Env{}(Θ₁ ∙ \stale{σ}, ρ \envextend{}, Θ₂ ∙ \stale{σ}, Γ ∙ \stale{σ})
}
\end{mathpar}
\end{definition}
